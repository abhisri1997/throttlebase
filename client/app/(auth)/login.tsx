      ...
      >
        <ScrollView contentContainerStyle={styles.scroll}>
          <View className="items-center mt-12 mb-16">
            <View className="w-20 h-20 rounded-3xl items-center justify-center shadow-lg mb-6"
          ...
          <View className="p-6 rounded-3xl mx-4 shadow-2xl"
            style={{ backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border }}
          >
            <Text className="text-2xl font-bold mb-6" style={{ color: colors.text }}>Welcome Back</Text>
            <Input
              label="Email Address"
            ...
            />
            <Button title="Sign In" onPress={handleLogin} isLoading={isLoading} className="mt-4" />
